...
import { StyleColorsProps, Tournament } from '@/types';
    ...
    >
      <View style={styles.imageContainer}>
        ...
        <View style={styles.badgeContainer}>
          ...
          >
            {statusInfo.dotColor && <View style={[styles.badgeDot, { backgroundColor: statusInfo.dotColor }]} />}
