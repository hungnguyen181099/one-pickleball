...
export default function ListReferee() {
  ...
  return (
    <ScreenContainer>
      ...
      <Flex style={{ paddingHorizontal: 16, paddingBottom: 8 }}>
        <Flex flex={1}>
          <Select
            value={tournamenntId}
      ...
      >
                  ...
                  >
                    <View style={{ flex: 1 }}>
                      ...
                      <Text
                        size="lg"
                        fontWeight={800}
                        style={{ marginTop: 8, letterSpacing: -0.5, color: colors.text }}
                      >
                    ...
                    <Flex justifyContent="space-between" alignItems="center">
                      <View style={{ flex: 1, alignItems: 'center' }}>
                        <Text
                          ...
                          numberOfLines={2}
                          textAlign="center"
                          style={{ marginBottom: 8, height: 40, textAlignVertical: 'center', color: colors.text }}
                        >
                          {item.athlete1_name}
                        </Text>
                        <Text
                          style={{
                            fontSize: 32,
                            fontWeight: '800',
                            color: isMatchStarted ? colors.text : colors.textTertiary,
                          }}
                        >
                      ...
                      <View style={{ width: 40, alignItems: 'center', marginHorizontal: 8 }}>
                        ...
                        >
                          <Text color="muted" fontWeight={900} size="xs">
                            VS
                          </Text>
                        </View>
                      </View>
        ...
        {data && (
          <Pagination
            currentPage={data.data.matches.current_page || 1}
            totalPages={data.data.matches.last_page || 1}
